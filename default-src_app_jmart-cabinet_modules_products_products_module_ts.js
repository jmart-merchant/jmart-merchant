...
let ProductsService = class ProductsService {
    ...
    changeProductStatus(id, status) {
        const url = `${this.baseUrl}/gw/catalog/v1/my/products/status-change/${id}`;
        return this.http.put(url, { 'status': status }).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_1__.map)(res => res.data));
    }
    changeProductStoreStatus(id, storeId, status) {
        const url = `${this.baseUrl}/gw/catalog/v1/my/company-store-products/change-availability/${storeId}/${id}`;
        return this.http.put(url, { 'available_status': status }).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_1__.map)(res => res.data));
    }
    changeProductBasePrice(id, price) {
        const url = `${this.baseUrl}/gw/catalog/v1/my/product-prices/change/${id}`;
        const headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_0__.HttpHeaders()
            .set('Content-Type', 'application/x-www-form-urlencoded; charset=UTF-8');
        const params = new _angular_common_http__WEBPACK_IMPORTED_MODULE_0__.HttpParams({
            fromObject: { price: price },
        });
        return this.http.put(url, params.toString(), { headers }).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_1__.map)(res => res.data));
    }
    changeProductCityPrice(id, cityId, price) {
        const url = `${this.baseUrl}/gw/catalog/v1/my/product-prices/change-by-city/${id}`;
        const headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_0__.HttpHeaders()
            .set('Content-Type', 'application/x-www-form-urlencoded; charset=UTF-8');
        const params = new _angular_common_http__WEBPACK_IMPORTED_MODULE_0__.HttpParams({
            fromObject: { price: price, city_id: cityId },
        });
        return this.http.put(url, params.toString(), { headers }).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_1__.map)(res => res.data));
    }
    deleteProductCityPrice(id, cityId) {
        const url = `${this.baseUrl}/gw/catalog/v1/my/product-prices/delete-by-city/${id}/${cityId}`;
        return this.http.delete(url).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_1__.map)(res => res.data));
    }
    getCities() {
        const url = `${this.baseUrl}/gw/dictionary/v1/cities`;
        return this.http.get(url)
            .pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_1__.map)(res => res.data));
    }
};
